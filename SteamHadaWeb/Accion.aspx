<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Accion.aspx.cs" Inherits="SteamHadaWeb.Accion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul>
        ...
        <div class="card">
            ...
            <asp:Label runat="server" Text ="Listado completo de juegos de Acción" style="font-size: large"></asp:Label>
            
    <asp:gridview runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SteamHadaBBDD" ForeColor="#333333" GridLines="None" Height="170px" Width="464px">
