<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="MerchPage.aspx.cs" Inherits="SteamHadaWeb.MerchPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .columnRight_MerchPage {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
        ...
        <h3>Todo el merchandising:</h3>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SteamHadaBBDD" Height="162px" Width="521px" AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="active">
            ...
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="imagen" DataImageUrlFormatString="~/imagenes/{0}" HeaderText="Item">
